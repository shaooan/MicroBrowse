...
@interface MBURLInterceptor : NSURLProtocol <CKHTTPConnectionDelegate> {
	NSMutableData *_data;
...
@property (strong) MBHostSettings *hostSettings;
@property (strong) MBHostSettings *originHostSettings;
